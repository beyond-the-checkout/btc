...
Or worse: they shut down entirely.`,
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "See scans as they happen. Which table tents get the most scans? Morning vs. evening traffic? Geographic data if you have multiple locations. Pro includes 10,000 events per month.",
    },
    {
      id: "qr-customization",
      description:
    ...
    tiers: [
      {
        ...
        ctaHref: "https://app.chko.sh/register?next=/onboarding/qr-landing",
      ...
      },
      {
        ...
        ctaLabel: "Start Pro",
        ctaHref: "https://app.chko.sh/register?next=/onboarding/qr-landing",
        note: "For restaurants with multiple menus or locations.",
      },
      {
        name: "Business",
        price: "$X/month",
        ...
        ctaLabel: "Contact us",
        ctaHref: "https://app.chko.sh/contact",
        note: "For restaurant groups and franchises.",
      },
    ],
    belowPricing:
